		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#foodsalesproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"foodsalesproject-display": {
								"semanticObject": "foodsalesproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=foodsalesproject",
									"url": sap.ui.require.toUrl("foodsalesproject")
								}
							}
						}
					}
